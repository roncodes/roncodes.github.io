	...
	projects = [
		{
			title: 'fleetbase',
			description:
				'an extendable api-first logistics operations platform.',
			logo_url:
		...
		},
		{
			...
			description:
				'cloudrealms is a javascript based rpg/mmorpg game engine.',
			logo_url:
				'https://user-images.githubusercontent.com/816371/141607795-4313bcd6-15ad-4599-81f5-eb4223503235.png',
			urls: {
		...
		},
		{
			title: 'here.watch',
			description:
				'a dead simple video sharing app with monetization controls.',
			urls: {
		...
		},
		{
			title: 'm3u8.download',
			description:
				'a simple web app for downloading m3u8 playlist files.',
			urls: {
		...
		},
		{
			title: 'appwiz.studio',
			description:
				'a no-code tool for form, document and native app generation.',
		},
		{
			title: 'twinflame',
