...
;define("personal/components/attach/popover", ["exports", "@ember/component", "@ember/template-factory", "@glimmer/component", "@glimmer/tracking", "@ember/object", "@ember/object/internals", "@ember/template", "@ember/runloop"], function (_exports, _component, _templateFactory, _component2, _tracking, _object, _internals, _template, _runloop) {
  ...
  0; //eaimeta@70e063a35619d71f0,"@glimmer/component",0,"@glimmer/tracking",0,"@ember/object",0,"@ember/object/internals",0,"@ember/template",0,"@ember/runloop",0,"@ember/template-factory"eaimeta@70e063a35619d71f
...
;define("personal/components/floating", ["exports", "@ember/component", "@ember/template-factory", "@glimmer/component", "@glimmer/tracking", "@ember/object", "@ember/array", "@floating-ui/dom"], function (_exports, _component, _templateFactory, _component2, _tracking, _object, _array, _dom) {
  ...
  0; //eaimeta@70e063a35619d71f0,"@glimmer/component",0,"@glimmer/tracking",0,"@ember/object",0,"@ember/array",0,"@floating-ui/dom",0,"@ember/template-factory"eaimeta@70e063a35619d71f
  function _initializerDefineProperty(target, property, descriptor, context) { if (!descriptor) return; Object.defineProperty(target, property, { enumerable: descriptor.enumerable, configurable: descriptor.configurable, writable: descriptor.writable, value: descriptor.initializer ? descriptor.initializer.call(context) : void 0 }); }
  function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
  function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
  function _toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
;define("personal/components/footer", ["exports", "@ember/component", "@ember/template-factory", "@glimmer/component", "@ember/object", "@ember/object/computed", "personal/utils/clean-object", "personal/utils/config"], function (_exports, _component, _templateFactory, _component2, _object, _computed, _cleanObject, _config) {
  ...
  0; //eaimeta@70e063a35619d71f0,"@glimmer/component",0,"@ember/object",0,"@ember/object/computed",0,"personal/utils/clean-object",0,"personal/utils/config",0,"@ember/template-factory"eaimeta@70e063a35619d71f
  function _initializerDefineProperty(target, property, descriptor, context) { if (!descriptor) return; Object.defineProperty(target, property, { enumerable: descriptor.enumerable, configurable: descriptor.configurable, writable: descriptor.writable, value: descriptor.initializer ? descriptor.initializer.call(context) : void 0 }); }
  function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
  function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
  function _toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
;define("personal/components/header", ["exports", "@ember/component", "@ember/template-factory", "@glimmer/component", "@glimmer/tracking", "@ember/object", "@ember/object/computed", "@ember/service"], function (_exports, _component, _templateFactory, _component2, _tracking, _object, _computed, _service) {
  ...
  0; //eaimeta@70e063a35619d71f0,"@glimmer/component",0,"@glimmer/tracking",0,"@ember/object",0,"@ember/object/computed",0,"@ember/service",0,"@ember/template-factory"eaimeta@70e063a35619d71f
  function _initializerDefineProperty(target, property, descriptor, context) { if (!descriptor) return; Object.defineProperty(target, property, { enumerable: descriptor.enumerable, configurable: descriptor.configurable, writable: descriptor.writable, value: descriptor.initializer ? descriptor.initializer.call(context) : void 0 }); }
  function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
  function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
  function _toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
;define("personal/components/lightbox", ["exports", "@ember/component", "@ember/template-factory", "@glimmer/component", "@glimmer/tracking", "@ember/object", "glightbox"], function (_exports, _component, _templateFactory, _component2, _tracking, _object, _glightbox) {
  ...
  _exports.default = void 0;
  var _class;
  0; //eaimeta@70e063a35619d71f0,"@glimmer/component",0,"@glimmer/tracking",0,"@ember/object",0,"glightbox",0,"@ember/template-factory"eaimeta@70e063a35619d71f
  function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
  function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
  function _toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
  function _applyDecoratedDescriptor(target, property, decorators, descriptor, context) { var desc = {}; Object.keys(descriptor).forEach(function (key) { desc[key] = descriptor[key]; }); desc.enumerable = !!desc.enumerable; desc.configurable = !!desc.configurable; if ('value' in desc || desc.initializer) { desc.writable = true; } desc = decorators.slice().reverse().reduce(function (desc, decorator) { return decorator(target, property, desc) || desc; }, desc); if (context && desc.initializer !== void 0) { desc.value = desc.initializer ? desc.initializer.call(context) : void 0; desc.initializer = undefined; } if (desc.initializer === void 0) { Object.defineProperty(target, property, desc); desc = null; } return desc; }
...
;define("personal/components/typewriter-text", ["exports", "@ember/component", "@ember/template-factory", "@glimmer/component", "@glimmer/tracking", "@ember/object", "@ember/utils"], function (_exports, _component, _templateFactory, _component2, _tracking, _object, _utils) {
  ...
  0; //eaimeta@70e063a35619d71f0,"@glimmer/component",0,"@glimmer/tracking",0,"@ember/object",0,"@ember/utils",0,"@ember/template-factory"eaimeta@70e063a35619d71f
  function _initializerDefineProperty(target, property, descriptor, context) { if (!descriptor) return; Object.defineProperty(target, property, { enumerable: descriptor.enumerable, configurable: descriptor.configurable, writable: descriptor.writable, value: descriptor.initializer ? descriptor.initializer.call(context) : void 0 }); }
  function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
  function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
  function _toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
;define("personal/templates/home", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  ...
  var _default = (0, _templateFactory.createTemplateFactory)({
    "id": "r9wwf+ip",
    "block": "[[[1,[28,[35,0],[\"Hello, my name is Ron, and I am a Software Engineer\"],null]],[1,\"\\n\\n\"],[10,0],[12],[1,\"\\n    \"],[10,0],[14,0,\"page-title page-title-home\"],[12],[1,\"\\n        \"],[10,1],[14,0,\"mr-0.5\"],[12],[1,\"👋🏾\"],[13],[1,\"\\n        \"],[10,1],[12],[1,\"Hello, my name is Ron, and I am a Software Engineer and former Marine.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n\\n    \"],[10,0],[14,0,\"aboutme\"],[12],[1,\"\\n        \"],[10,2],[12],[1,\"My journey in tech began in middle school when my father introduced me to computers. My mother further sparked my interest by introducing me to a web page builder by Bellsouth.net, leading me down a rabbit hole of learning to code and build.\"],[13],[1,\"\\n        \"],[10,2],[12],[1,\"Since then, I served in the Marines and studied Robotics and Embedded Systems at the University of Advancing Technology which enabled me to kick-start my professional career as a software engineer. This unique combination of experience, along with my innate passion for building and learning, is why I’m now obsessed with creating innovative digital products and experiences that perform like magic.\"],[13],[1,\"\\n        \"],[10,2],[12],[1,\"Before the outbreak of COVID-19, I co-founded \"],[10,3],[14,6,\"https://fleetbase.io\"],[14,0,\"flb-link\"],[14,\"target\",\"_fleetbase\"],[12],[1,\"Fleetbase\"],[13],[1,\" - an API-based platform that enables fast development of logistics and supply-chain apps. While building Fleetbase, I gained a deep understanding of the shipping and logistics industries, including common challenges. This allowed me to develop innovative software solutions that tackle complex problems.\"],[13],[1,\"\\n        \"],[10,2],[12],[1,\"When I’m not working professionally I like to explore new technologies and hack on side-projects in augmented reality, game development, and apps.\"],[13],[1,\"\\n        \"],[10,2],[12],[1,\"One of my passion projects, \"],[10,3],[14,6,\"https://horrormovienight.app/\"],[14,0,\"hmn-link\"],[14,\"target\",\"_horrormovienight\"],[12],[1,\"Horror Movie Night\"],[13],[1,\", recommends the most skin-crawling horror movies based on user's mood and is used by over 6,000 iOS and Android users globally.\"],[13],[1,\"\\n        \"],[10,2],[12],[1,\"Some of my non technical hobbies include hiking, coffee, travel, and gaming.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n\\n\"],[13]],[],false,[\"page-title\"]]",
  ...
  function getCvData() {
    return {
      ...
      education: [{
        ...
        highlights: ['Awarded the Ray Kurzweil Scholarship.', 'Withdrew after 3 semesters for military service reasons.']
      }],
      projects: [{
...
;
          if (!runningTests) {
            require("personal/app")["default"].create({"name":"personal","version":"0.1.3+3c5b57ee"});
          }
