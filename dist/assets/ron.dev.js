...
;define("personal/components/header", ["exports", "@ember/component", "@ember/template-factory", "@glimmer/component", "@glimmer/tracking", "@ember/object", "@ember/service"], function (_exports, _component, _templateFactory, _component2, _tracking, _object, _service) {
  ...
  /*
    <div class="relative" ...attributes>
      <div class="relative z-20">
          <div class="max-w-7xl mx-auto flex justify-between items-center py-5 px-8 md:justify-start md:space-x-4">
              ...
              <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
                  <nav class="main-nav flex lowercase">
                      ...
                      <LinkTo @route="art" class="text-base font-medium text-gray-500 hover:text-gray-900 dark:hover:text-gray-200">
                          Art
                      </LinkTo>
                      <LinkTo @route="writing" class="text-base font-medium text-gray-500 hover:text-gray-900 dark:hover:text-gray-200">
                          Writing
                      </LinkTo>
                  </nav>
...
;define("personal/templates/home", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  ...
  var _default = (0, _templateFactory.createTemplateFactory)({
    "id": "IGoUdbiU",
    "block": "[[[10,0],[12],[1,\"\\n    \"],[10,\"h3\"],[14,0,\"page-title\"],[12],[1,\"👋🏾 Hello, my name is Ronald A. Richardson.\"],[13],[1,\"\\n    \"],[10,0],[14,0,\"mb-10 space-y-5\"],[12],[1,\"\\n        \"],[10,2],[12],[1,\"\\n            This is my personal space on the web, by heart I am a creative and take absolute pleasure from making creations of different mediums.\\n        \"],[13],[1,\"\\n        \"],[10,2],[12],[1,\"\\n            🚨 This website is still a work in progress...\\n        \"],[13],[1,\"\\n    \"],[13],[1,\"\\n\"],[13]],[],false,[]]",
...
;
          if (!runningTests) {
            require("personal/app")["default"].create({"name":"personal","version":"0.1.1+51d17a52"});
          }
